...
struct Api_Reports : Codable {
    let result : [Res_UserReports]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([Res_UserReports].self, forKey: .result)
...
struct Res_UserReports : Codable {
    let id : String?
    let user_id : String?
    let name : String?
