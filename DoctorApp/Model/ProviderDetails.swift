...
struct Api_ProviderDetails : Codable {
    let result : Res_ProviderDetails?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(Res_ProviderDetails.self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct Res_ProviderDetails : Codable {
    let id : String?
    let store_id : String?
    ...
    let provider_time_details : [Provider_time_details]?
//    let provider_images : [String]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case provider_time_details = "provider_time_details"
//        case provider_images = "provider_images"
    ...
    init(from decoder: Decoder) throws {
        ...
        time_slot = try values.decodeIfPresent([Time_slot].self, forKey: .time_slot)
        ...
        provider_time_details = try values.decodeIfPresent([Provider_time_details].self, forKey: .provider_time_details)
//        provider_images = try values.decodeIfPresent([String].self, forKey: .provider_images)
        fav_provider = try values.decodeIfPresent(String.self, forKey: .fav_provider)
    }

}

struct Time_slot : Codable {
...
struct Provider_time_details : Codable {
    let id : String?
